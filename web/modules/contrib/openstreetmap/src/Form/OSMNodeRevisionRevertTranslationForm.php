...
/**
 * Provides a form for reverting a OSM Node revision for a single trans.
 *
 * @ingroup openstreetmap
 */
class OSMNodeRevisionRevertTranslationForm extends OSMNodeRevisionRevertForm {
  ...
  public function getFormId() {
    return 'osm_node_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $osm_node_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $osm_node_revision);
